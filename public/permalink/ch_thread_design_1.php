...
<html>
	<head>
		<title>2ちゃんねるスレッドテキストベースまとめツール Var.1.01</title>
		<!-- meta -->
		<meta charset="UTF-8">
	...
	<body>
<h1>2ちゃんねるスレッドテキストベースまとめツール Var.1.01</h1>
...
<p class="m_0">生成出来る例：（コピペして、まとめHTML作成をクリックすると生成されます）</p>
<p class="m_0">1 ：名無しさん＠お腹いっぱい。：2013/03/02(土) 12:30:44.26 ID:j3+senoR</p>
...
<p class="m_0">更新情報</p>
<p>2014年10月21日：Var.1.00リリース</p>

<p>2015年08月08日：Var.1.01リリース</p>
...
$post = post_security();
$ch_thread_content = $post["ch_thread_content"];
