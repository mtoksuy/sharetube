...
class Controller_AuthorRecruiting extends Controller_Basic_Template {
	// 親before実行
	...
	public function action_index() {
		// タイトルセット
		$this->basic_template->view_data["title"] = 'ライター募集 | '.TITLE;
		// cssデータセット
		$this->basic_template->view_data["external_css"] = View::forge('permalink/about/externalcss');

		// html取得
		$about_html = View::forge('permalink/authorrecruiting');
