...
class Controller_Login_Admin_Matome_Delete_Preview extends Controller_Login_Admin_Matome_Preview_Template {
...
//			$preview_article_res = Model_Login_Post_Preview_Basis::preview_article_get($method);
			$preview_article_res = Model_Login_Matome_Delete_Preview_Basis::delete_article_res_get($method);
