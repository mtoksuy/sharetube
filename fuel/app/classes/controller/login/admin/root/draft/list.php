 ...
 * Rootコントローラー
 * 
 * 全ユーザーの下書き記事をリスト表示する機能
 * 
 * 
 */

class Controller_Login_Admin_Root_Draft_List extends Controller_Login_Template {
	public function action_index() {
		// ログインチェック
		$login_check = Model_Login_Basis::login_check();
		if($login_check) {
			// 全ユーザー下書きを取得
			$draft_article_list_get_res = Model_Login_Root_Basis::all_draft_article_list_get();
