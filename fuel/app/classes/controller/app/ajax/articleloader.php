...
* 
*/
class Controller_App_Ajax_Articleloader extends Controller {
	// アクション
	public function action_index() {
		...
		// 記事一覧データ取得
		$list_query = Model_Article_Basis::list_get($segment_info_get_array, $article_number, $article_type);
		// 記事一覧HTML生成
		$article_list_html = Model_Article_Html::app_list_html_create($list_query, $article_type);
