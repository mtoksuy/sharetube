...
*
*/
class Controller_App_Vine extends Controller_App_Vine_Template {
...
*/
		// 記事一覧データ取得
		$list_query        = Model_Article_Basis::list_get($segment_info_get_array, null ,'vine');
		// 記事一覧HTML生成
		$article_list_html = Model_Article_Html::app_list_html_create($list_query, 'vine');
		// コンテンツデータセット
	...
	public function action_vine($method) {
		// 記事のHTML生成
		$article_data_array = Model_Article_Html::article_html_create($method, 'vine');
		// 記事のメタ生成
