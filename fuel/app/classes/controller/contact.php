...
//			var_dump($post);
		...
		// タイトルセット
		$this->basic_template->view_data["title"] = 'お問い合わせ | '.TITLE;
		// cssデータセット
		$this->basic_template->view_data["external_css"] = View::forge('permalink/contact/externalcss');
...
/*		// シャッフル記事データ取得 
		$shuffle_res = Model_Article_Basis::article_shuffle_get(0, 'article');
		// シャッフル記事HTML生成
