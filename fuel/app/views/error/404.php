...
<html>
	<head>
		<title>Sharetube [シェアしたい情報を集める] キュレーションプラットフォームサービス</title>
		<!-- meta -->
...
<div class="mobile_header_ad">
					...
					</div><div class="mobile_orverlay_ad">
						<div class="mobile_orverlay_ad_content">
...
-->
					...
					<section class="drawer_nav_copy">
						<p>&copy; 2015 <a href="">Sharetube</a></p>
					</section>
				</nav>
			<!-- main -->
			<div class="main clearfix">
				...
				<div class="main_contents clearfix">
						エラーページ<br><br><br><br><br><br><br><br><br>				</div>
				<!-- sidebar -->
				<div class="sidebar">
									</div>
			</div>
...
-->
				...
				<div class="footer_bottom">
					<div class="footer_bottom_contents">
						<!-- コピーライト -->
						<section id="copy">
							<p class="m_0">&copy; 2015 <a href="http://sharetube.jp/">Sharetube</a></p>
						</section>
						<!--  -->
