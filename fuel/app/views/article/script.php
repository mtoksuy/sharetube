			...
			<!-- シェアを促すプラグイン -->
			<script type="text/javascript" src="<?php echo HTTP; ?>assets/js/article/share_urge.js"></script>
			...
			<!-- 記事のサムネを背景に表示するプラグイン -->
<!--
			<script type="text/javascript" src="<?php echo HTTP; ?>assets/js/article/background_thumbnail_view.js"></script>
-->
